...
lista = []
matriz = []
for i in range (100): # le doy un rango de 100 veces sacar los tres numeros diferentes
    n1 = randint(0,10) # solo permite darles valores a n1 de valores del 0 a 9
